        ...
        <section className="w-full h-screen flex justify-between overflow-hidden">
            ...
            <div className="w-2/4 h-screen pt-32">
                ...
                <div className="mt-4">
                    ...
                    <button className="mt-2 opacity-50 rounded-lg border-2 border-red-600 text-red-600 py-4 px-6 font-bold hover:bg-red-600 hover:border-red-600 hover:text-white transition duration-200">Delete Account</button>
                </div>
            </div>
        </section>
    )
